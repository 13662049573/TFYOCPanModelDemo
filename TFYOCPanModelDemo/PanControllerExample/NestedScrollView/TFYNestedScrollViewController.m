//
//  TFYNestedScrollViewController.m
//  TFYPanModalDemo
//
...
@implementation TFYNestedScrollViewController
...
- (void)prepareData {
    ...
    for (int i = 0; i < 40; ++i) {
        [list1 addObject:[UIColor tfy_randomColor]];
    }

    for (int j = 0; j < 12; ++j) {
        [list2 addObject:[UIColor tfy_randomColor]];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TFYColorCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(TFYColorCell.class) forIndexPath:indexPath];
    if (tableView == self.tableView1) {
...
- (UITableView *)createTable {
    ...
    [tableView registerClass:TFYColorCell.class forCellReuseIdentifier:NSStringFromClass(TFYColorCell.class)];
