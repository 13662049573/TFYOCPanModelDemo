...
@interface TFYCollectionPanModalView () <UICollectionViewDelegate, UICollectionViewDataSource>

@property (nonatomic, strong) UICollectionView *collectionView;

@end

@implementation TFYCollectionPanModalView
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    TFYColorCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass(TFYColorCollectionViewCell.class) forIndexPath:indexPath];
    return cell;
}
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([cell isKindOfClass:TFYColorCollectionViewCell.class]) {
        cell.backgroundColor = [UIColor tfy_randomColor];
    }
}
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:TFYColorCollectionViewCell.class  forCellWithReuseIdentifier:NSStringFromClass(TFYColorCollectionViewCell.class)];
