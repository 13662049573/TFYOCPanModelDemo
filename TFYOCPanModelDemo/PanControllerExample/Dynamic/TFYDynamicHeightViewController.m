//
//  TFYDynamicHeightViewController.m
//  TFYPanModal_Example
//
...
@interface TFYDynamicHeightViewController () <TFYPanModalPresentable>
...
@property (nonatomic, strong) TFYPanModalShadow *shadowConfig;
...
@implementation TFYDynamicHeightViewController
...
- (void)onTapChangeBG {
    ...
    if (self.bgFlag) {
        config = [TFYBackgroundConfig configWithBehavior:TFYBackgroundBehaviorDefault];
